...
namespace Level1.DataLayer.NHibernateConfigurations
{
    ...
    public class NHibernateMapperSession : IMapperSession
    {
        ...
        public IQueryable<Person> company => _session.Query<Person>();
        ...
        public async System.Threading.Tasks.Task Save(List<Person> entity)
        { 
            await _session.SaveOrUpdateAsync(entity);
        }

        public async System.Threading.Tasks.Task Delete(Person entity)
        {
